...
public class DBService {
	...
	public void instaciaDB() {
		Tecnico tec1 = new Tecnico(null,"Marcio Santos","76155390215","mssantostuc@gmail.com",encoder.encode("123"));
		tec1.addPerfil(Perfil.ADMIN);
		Tecnico tec2 = new Tecnico(null,"Richard Stallman","550.482.150-95","stalman@mail.com",encoder.encode("123"));
		...
		Cliente cli1 = new Cliente(null,"Albert Einstein","111.661.890-74","eistein@mail.com",encoder.encode("123"));
